...
**安装**
- 直接从 [claude-plugins-community(eli5)](https://github.com/anthropics/claude-plugins-community/blob/main/eli5/skills/eli5/SKILL.md) 下载文件，然后放到 `C:\Users\buerjia\.agents\skills\eli5` 目录下；
- 或者直接把链接丢给agent，让它安装；
重启agent工具即可。
