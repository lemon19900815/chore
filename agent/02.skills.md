...
[eli5](https://github.com/anthropics/claude-plugins-community/blob/main/eli5/skills/eli5/SKILL.md)
...
## 6. eli5
[eli5-小林coding介绍](https://mp.weixin.qq.com/s/p2zuFoaE2Fjnr9oreJrrzA)

ELI5 是「Explain Like I’m 5」的缩写。你可以理解成，不管这个话题有多复杂，都先把我当成一个完全不了解的人来讲。

**安装**
- 直接从 [claude-plugins-community(eli5)](https://github.com/anthropics/claude-plugins-community/blob/main/eli5/skills/eli5/SKILL.md) 下载文件，然后放到 `C:\Users\maccura\.agents\skills\eli5` 目录下；
- 或者直接把链接丢给agent，让它安装；
重启agent工具即可。

这个 skill 的内容也很简单（人类追求的从来都是简单）：
![](img/02.skills-2.png)

**用法**

在 agent工具 里输入 `/eli5`，后面跟上你想了解的东西。
```bash
/eli5 微积分
```

**使用场景：**
我觉得特别适合给小朋友讲解某些知识，可以让他们建立更直观的理解！
