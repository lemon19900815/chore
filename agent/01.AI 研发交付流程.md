...
这几个都是 `langchain-ai` 的产品。

| 阶段   | 技术组件                                                      | 目标                                   | 主要解决问题                                                                                              |
| ---- | --------------------------------------------------------- | ------------------------------------ | --------------------------------------------------------------------------------------------------- |
| 链式接入 | [LangChain](https://github.com/langchain-ai/langchain)    | 把 GitLab、禅道、文件系统、测试命令、流水线查询封装为统一工具   | AI 应用开发框架：怎么方便地调用各种 LLM、Embedding、数据库、工具                                                            |
| 流程编排 | [LangGraph](https://github.com/langchain-ai/langgraph)    | 将需求、OpenSpec、开发、MR、审核、修复、部署 建模为工作流程图 | Agent 工作流框架：LangGraph 是一个状态机（State Machine）+ DAG Workflow Engine                                    |
| 复杂执行 | [Deep Agents](https://github.com/langchain-ai/deepagents) | 多Agent协作开发                           | /                                                                                                   |
| 观测评估 | LangSmith                                                 | 调试和评估 效果，记录 trace、评估 Prompt等         | 调试、测试、监控平台（<font color="blue">商业产品</font>）<br>开源平替：[Langfuse](https://github.com/langfuse/langfuse) |
