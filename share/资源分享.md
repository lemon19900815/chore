...
- [easygif](https://easygif.cn/)

  一个在浏览器中免费制作GIF的网站。

- [在线的专业 PDF 工具](https://pdfcraft.devtoolcafe.com/zh/tools/)
...
- [windows激活](https://zhuanlan.zhihu.com/p/26382181917?d=1778060954595)
...
- [office激活工具](https://www.ghxi.com/officec2rins.html)
	在首页选择office版本后，执行安装office，如果当前版本不支持激活，软件会提示。
	![](./img/install-office.png)
	下载安装完office后，进入使用程序进行激活（如果激活错误，使用`Office零售转批量`）。
	![](./img/active-office.png)
...
- [DeepDiagram AI](https://deepd.cturing.cn/)：绘图Agent

  开源的 AI 应用，用自然语言驱动内置的 mermaid、echarts、mindmap、Draw.io 等绘图工具生成图表。

  ![](./img/deepd.cturing.cn.png)
